...
>>> cur = conn.cursor()
>>> cur.execute("CREATE TABLE user_reaction (id SERIAL, username VARCHAR(20) NOT NULL, reaction VARCHAR(10) NOT NULL, timestamp timestamp without time zone NOT NULL, PRIMARY KEY(id))")
